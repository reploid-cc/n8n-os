# Implementation Prompt for RFC-001: Project Foundation & UI System
...
This implementation covers RFC-001, which focuses on Project Foundation & UI System setup for the n8n-os platform. Please refer to the following documents:
...
- @RFC-001-Project-Foundation-UI-System.md for the specific requirements being implemented
...
Please only implement the features specified in @RFC-001-Project-Foundation-UI-System.md. If you identify dependencies on features from other RFCs, note them but do not implement them unless explicitly instructed.
