# Implementation Prompt for RFC-003: Homepage & Static Content
...
This implementation covers RFC-003, which focuses on Homepage & Static Content for the n8n-os platform. Please refer to the following documents:
...
- @RFC-003-Homepage-Static-Content.md for the specific requirements being implemented
...
Please only implement the features specified in @RFC-003-Homepage-Static-Content.md. If you identify dependencies on features from other RFCs, note them but do not implement them unless explicitly instructed.
