# Implementation Prompt for RFC-004: Workflow Pages & Content Management
...
This implementation covers RFC-004, which focuses on Workflow Pages & Content Management for the n8n-os platform. Please refer to the following documents:
...
- @RFC-004-Workflow-Pages-Content-Management.md for the specific requirements being implemented
...
Please only implement the features specified in @RFC-004-Workflow-Pages-Content-Management.md. If you identify dependencies on features from other RFCs, note them but do not implement them unless explicitly instructed.
