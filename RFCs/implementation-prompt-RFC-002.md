# Implementation Prompt for RFC-002: Core Layout & Navigation
...
This implementation covers RFC-002, which focuses on Core Layout & Navigation system for the n8n-os platform. Please refer to the following documents:
...
- @RFC-002-Core-Layout-Navigation.md for the specific requirements being implemented
...
Please only implement the features specified in @RFC-002-Core-Layout-Navigation.md. If you identify dependencies on features from other RFCs, note them but do not implement them unless explicitly instructed.
